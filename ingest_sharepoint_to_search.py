...
The script keeps credentials out of source code. It uses the active Azure CLI session to:
...
def download_graph_file(drive_id: str, source_file: SourceFile, graph_token: str) -> bytes:
    url = f"https://graph.microsoft.com/v1.0/drives/{drive_id}/items/{source_file.item_id}/content"
...
def main() -> int:
    ...
    try:
        doc_intel_credential = "key:" + run_az(
            [
                "cognitiveservices",
                "account",
                "keys",
        ...
        doc_intel_credential = "aad:" + get_cli_token("https://cognitiveservices.azure.com")
